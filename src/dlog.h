...
{   
    ...
    mp_limb_t** random_tG_add_skG;                  // r random points of a*G + b*kG (using X, Y coordinate in Montgomery Form.)
    mp_limb_t** random_t;                           // r random multipliers a
    mp_limb_t** random_s;                           // r random multipliers b
} __dlog_obj_struct;
